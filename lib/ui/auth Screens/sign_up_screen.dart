...
import 'package:mobile_assessment_flutter/ui/auth%20Screens/verify_number_screen.dart';
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      children: [
                        AuthButton(label:  "Back",textColor: Colors.black, onTap: (){Navigator.of(context).pop();
                        },),
                        AuthButton(label:  "Next",buttonColor: AppColors.primaryGreen, onTap: ()
                          {
