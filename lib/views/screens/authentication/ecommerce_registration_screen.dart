...
class EcommerceRegistrationScreen extends StatelessWidget {
  static const route =
      BaseAuthenticationScreen.route + "/registration/ecommerce";

  const EcommerceRegistrationScreen({Key? key}) : super(key: key);
